...
rows = []
#Wikipedia is not allowing me to read the data, so I have to use the Nasa_Exoplanet_Archive.csv file
...
fig = px.bar(x=hd_10180_planet_names, y=hd_10180_planet_masses, title="Project C131 - Comparing System HD 10180's planets with each other")
...
fig = px.scatter(x=planet_radiuses, y=planet_masses, size=planet_gravity, hover_data=[planet_names], title="Proect C131 - Comparing Radii and Masses")
